...
<div id ="mainDiv">
<form id="boardUpdateForm" method="post" action="/ackProject_01/board/boardUpdate.do">
			...
			<table border="0" cellpadding="0" cellspacing="0"
				...
				<tr>
					<th>제목</th>
					<td>
						<input type="text" class="input_subject" name="subject"
							id="subject" value="${list.subject}" title="제목입력"/>
				...
				<tr>
					...
					<td><input type="text" class="input_name" name="name"
						id="name" value="${list.name}" title="이름입력" readonly="readonly"></td>
				</tr>
				<tr>
					<th>내용</th>
					<td><pre><textarea cols="1" rows="1" name="content" id="content"
							title="내용입력">${list.content}</textarea></pre>
					</td>
				</tr>
			</table>
			<div style="text-align:center;">
				<input style="cursor: pointer;" type="button" id="boardBtn" value="수정">
